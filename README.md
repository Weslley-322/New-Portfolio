...
Bem-vindo ao protocolo de identidade digital. Esta interface foi desenvolvida com tecnologias front-end para simular um ambiente de terminal de alto desempenho e estética industrial.
...
* **Estilização:** Tailwind CSS (Cyber Orange Theme)
* **Animações:** Framer Motion (Typewriter & Motion Effects)
* **Ícones:** Lucide React
...
* **Technical Vault:** Galeria de projetos com efeitos de varredura digital (Scanline) e alta performance.
